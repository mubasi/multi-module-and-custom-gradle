...
pipeline {
    agent {
        node {
            label 'slave-00'
            customWorkspace "workspace/${env.BRANCH_NAME}/src/git.bluebird.id/outlet-vsm"
        }
    }
    environment {
        SERVICE="mall-officer"
        BUCKET="officer-apk"
        ...
        stage('Prepare') {
            steps {
                withCredentials([file(credentialsId: 'fa022f45-5480-435e-9c46-67e24a57e285', variable: 'gs'),
                                 file(credentialsId: '4626b35f-3098-43ad-b52c-5161120d77e0', variable: 'jks'),
                                 file(credentialsId: 'ed61151f-a4f7-40a3-b575-452790c1ef00', variable: 'local'),
                ...
                sh "chmod 644 google-services.json officer.jks local.properties service-account.json && cat local.properties"
