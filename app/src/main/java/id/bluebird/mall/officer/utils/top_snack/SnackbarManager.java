package id.bluebird.mall.officer.utils.top_snack;
...
class SnackbarManager {
    ...
    private static id.bluebird.mall.officer.utils.top_snack.SnackbarManager sSnackbarManager;

    static id.bluebird.mall.officer.utils.top_snack.SnackbarManager getInstance() {
        if (sSnackbarManager == null) {
            sSnackbarManager = new id.bluebird.mall.officer.utils.top_snack.SnackbarManager();
        }
    ...
    private void handleTimeout(SnackbarRecord snackbarRecord) {
        synchronized (mLock) {
            if (mCurrentSnackbar == snackbarRecord || mNextSnackbar == snackbarRecord) {
                cancelSnackbarLocked(snackbarRecord, TSnackbar.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
