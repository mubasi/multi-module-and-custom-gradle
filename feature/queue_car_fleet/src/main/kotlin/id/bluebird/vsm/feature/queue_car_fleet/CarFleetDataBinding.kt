...
object CarFleetDataBinding {
    ...
    fun setColorTextPassenger(view: TextView, withPassenger: Boolean, statusPassenger: Boolean) {
        view.setTextColor(
            view.context.getColor(
                if (statusPassenger) setColorWithPassenger(withPassenger) else setColorWithoutPassenger(
                    withPassenger
                )
            )
        )
    ...
    fun setImagePassenger(view: AppCompatImageView, withPassenger: Boolean, stPassenger: Boolean) {
        view.setImageDrawable(
            AppCompatResources.getDrawable(
                view.context,
                if (stPassenger) setImageWitPassenger(withPassenger) else setImageWithoutPassenger(
                    withPassenger
                )
            )
        )
    ...
    fun setBorderPassenger(view: CardView, borderPassenger: Boolean, passengerStatus: Boolean) {
        view.setBackgroundColor(view.context.getColor(
            if (passengerStatus) setBorderWithPassenger(borderPassenger) else setBorderWithoutPassenger(
                borderPassenger
            )
        )
        )
