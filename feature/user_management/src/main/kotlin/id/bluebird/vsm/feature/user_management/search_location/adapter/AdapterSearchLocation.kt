...
import id.bluebird.vsm.feature.user_management.databinding.ItemLocationBinding
...
class AdapterSearchLocation(private val _vm: SearchLocationViewModel) :
    ListAdapter<Location, AdapterSearchLocation.ViewHolder>(LocationDiffUtil()) {
