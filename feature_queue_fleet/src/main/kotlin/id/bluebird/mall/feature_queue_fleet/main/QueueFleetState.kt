...
sealed class QueueFleetState {
    ...
    data class RecordRitaseToDepart(val fleet: FleetItem, val subLocationId: Long, val queueId: String): QueueFleetState()
    ...
    data class SuccessDepartFleet(val fleetNumber: String, val isWithPassenger: Boolean): QueueFleetState()
    data class SearchQueueToDepart(val fleet: FleetItem, val locationId: Long, val subLocationId: Long, val currentQueueId: String): QueueFleetState()
