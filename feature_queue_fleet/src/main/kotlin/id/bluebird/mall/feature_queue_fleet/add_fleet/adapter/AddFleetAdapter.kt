package id.bluebird.mall.feature_queue_fleet.add_fleet.adapter
...
import id.bluebird.mall.feature_queue_fleet.databinding.ItemAddFleetBinding


class AddFleetAdapter(private val viewModel: AddFleetViewModel) :
    ListAdapter<String, AddFleetAdapter.ViewHolder>(AddFleetDiffUtil()) {
